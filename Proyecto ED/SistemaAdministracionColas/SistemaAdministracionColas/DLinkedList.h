...
/*
	...
	Nombre del archivo: DLinkedList.h

	Descripción: Implementación de la Estructura de Datos DLinkedList.
	Esta clase es una implementación de una lista doblemente enlazada. 
	Utiliza nodos que contienen un elemento y punteros al siguiente y anterior nodo.
